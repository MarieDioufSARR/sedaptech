...
export default function Camera() {
  const { camera } = siteConfig.solutionPage;
  ...
  return (
        ...
        <div className="mx-auto mt-20 max-w-5xl overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-lg">
          <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14 p-8 lg:p-12">
            ...
            <div className="flex justify-center">
              <div className="relative flex w-full max-w-105 items-center justify-center rounded-3xl bg-linear-to-br from-emerald-50 via-slate-50 to-white p-8 lg:p-10">
                <Image
    ...
    "
                ...
                <div className="absolute inset-0 rounded-3xl bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.08),transparent_70%)] animate-glow" />
              </div>
            </div>
